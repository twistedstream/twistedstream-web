...
import { Invite, RegisteredAuthenticator, Share, User } from "../types/entity";
...
test("data/in-memory", async (t) => {
  ...
  t.test("InMemoryDataProvider", async (t) => {
    t.test("constructor", async (t) => {
      t.test("sets up in-memory arrays", async (t) => {
        const users: any[] = [];
  ...
  t.test("instance methods", async (t) => {
    ...
    t.test("insertCredential", async (t) => {
      ...
      t.test("if user doesn't exist, throws expected exception", async (t) => {
        const user1 = testUser1();
    ...
    t.test("updateInvite", async (t) => {
      t.test("if invite exists, performs expected updates on it", async (t) => {
        const user2 = testUser2();
        const users = [user2];
        const invite1 = testInvite1(user2);
    ...
    t.test("updateShare", async (t) => {
      t.test("if share exists, performs expected updates on it", async (t) => {
        const user2 = testUser2();
        const users = [user2];
    ...
    t.test("findDocumentInfo", async (t) => {
      ...
      t.test("if nonexistent URL, returns nothing", async (t) => {
        const file1 = testFile1();
        const files = [file1];
        const provider = createInstance({ files });
